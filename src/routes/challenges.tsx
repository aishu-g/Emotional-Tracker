        ...
        <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
          <TabsList>
            <TabsTrigger value="all" className="cursor-pointer">
              {t("All")} <span className="ml-1.5 text-muted-foreground">{challenges.length}</span>
            </TabsTrigger>
            <TabsTrigger value="Open" className="cursor-pointer">{t("Open")}</TabsTrigger>
            <TabsTrigger value="Investigating" className="cursor-pointer">{t("Investigating")}</TabsTrigger>
            <TabsTrigger value="Resolved" className="cursor-pointer">{t("Resolved")}</TabsTrigger>
          </TabsList>
        </Tabs>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[480px]">
            <form onSubmit={handleCreate}>
              <DialogHeader>
                <DialogTitle>{t("Create Challenge")}</DialogTitle>
                <DialogDescription>
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="ch-title">{t("Title")} *</Label>
                  <Input
                    id="ch-title"
              ...
              <DialogFooter>
                ...
                <Button type="submit" className="cursor-pointer">{t("Create Challenge")}</Button>
              </DialogFooter>
            </form>
          </DialogContent>
        </Dialog>
